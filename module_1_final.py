...
students_list.sort()
print('Отсортированный список студентов:', students_list)
print('Количество студентов:', len(students_list))
students_avg_points = {students_list[0]:sum(grades[0])/len(grades[0]),
